...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 06, 2021 at 02:30 PM
...
CREATE TABLE `answers` (
  ...
  `source_path` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `origin` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `category` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `similar_question` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_by` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `answers` (`id`, `brand_id`, `indication_id`, `question`, `answer`, `answer_date`, `source_name`, `source_path`, `origin`, `category`, `similar_question`, `created_by`, `date_created`) VALUES
('2177b850-3ef0-11ec-9b2e-5b517c0de5a2', '4ea08b60-30de-11ec-a3bf-c72f74a07716', 'fee5db40-30ea-11ec-b6f9-638294b1396e', 'question', 'answer', '2021-11-06', 'Test docuement', '/Test Document', '2', 'category', '-', 'Administrator', '0000-00-00');
